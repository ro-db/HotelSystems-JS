      ...
      onKeyDown: function(t, e) {
        ...
        n === m.esc
          ...
          : a &&
            (t.preventDefault(),
            e.setState({
              hilightedDate: ((o = e.state.hilightedDate),
              (r = a),
    ...
    year: {
      ...
      onClick: {
        'dp-year': function(t, e) {
          e.setState({
            hilightedDate: ((n = e.state.hilightedDate),
    ...
    return (
      ...
      (x.adjustPosition = function() {
        ...
        (c = x),
          ...
          (d = u ? s : i),
          n.classList &&
            (n.classList.toggle('dp-is-above', u),
            n.classList.toggle('dp-is-below', !u)),
          (n.style.top = d + 'px'),
          (p = l),
          (h = f),
          (v = c.el),
  ...
  (t.TinyDatePicker = e),
    (t.DateRangePicker = function(t, e) {
      ...
      var o,
        ...
        c.querySelector('.dr-cals')),
        r = {
          start: void 0,
          end: void 0
        },
        i = F(
          a.querySelector('.dr-cal-start'),
          g({}, e.startOpts, {
            mode: 'dp-permanent',
            dateClass: p
          })
      ...
      function p(t) {
        ...
        return (
          ...
          (e < a && n <= e) || (e <= n && a < e))
            ? 'dr-in-range '
            : '') + (h(t, r.start) || h(t, r.end) ? 'dr-selected ' : '')
        );
      }
      return (
        i.on(u),
